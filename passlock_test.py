...
class TestClass(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_user.fname,'Martha')
        self.assertEqual(self.new_user.lname,'Valary')
...
class TestCredentials(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.userName,'marthavallary')
    ...
    def test_save_many_accounts(self):
        ...
        '''
        self.new_credential.save_details()
        test_credential = Credentials("Instagram","VallandyValary","Mfh45hfk") 
